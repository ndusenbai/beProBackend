...
QUERY_FIRST_DATE = openapi.Parameter('first_date', openapi.IN_QUERY, description='monday date (Example: 2022-01-01)', type=openapi.FORMAT_DATE)
QUERY_LAST_DATE = openapi.Parameter('last_date', openapi.IN_QUERY, description='monday date (Example: 2022-01-01)', type=openapi.FORMAT_DATE)
