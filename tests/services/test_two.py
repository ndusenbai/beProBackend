...
class TestTwo:
    ...
    VERY_HIGH_RESULT = {
        ...
        'kz': {
            'classification': 'өте жоғары',
            'percent': 5,
            'summary': 'Аға менеджер, жетекші - қызметкерлерді тікелей бақылай алады немесе өз кезегінде қызметкерлерді тікелей басқаратын бірнеше жетекшілерді бақылай алады. Сонымен қатар, компаниядағы ең үлкен немесе ең маңызды топ немесе топтарды басқара алады.'
        }
    }
    HIGH_RESULT = {
        'ru': {
        ...
        'kz': {
            'classification': 'жоғары',
            'percent': 10,
            'summary': 'Аға немесе кіші менеджер – қызметкерлерді тікелей басқара алады. Негізінен өндірістік тапсырмалардың орындалуын қадағалайды. Көбінесе оған бөлінген ресурстарды пайдалануда жауапты.'
    }
    }
    ABOVE_AVERAGE_RESULT = {
        ...
        'kz': {
            'classification': 'орташадан жоғары',
            'percent': 35,
            'summary': 'Басшылық лауазымда емес - жоғары лауазымдарды бермеу ұсынылады. Басқаларды басқара алмайды. Бірақ жауапкершілігі азырақ тапсырмаларды сеніп тапсыруға болады.'
        }
    }
    BELOW_AVERAGE_RESULT = {
        ...
        'kz': {
            'classification': 'орташадан төмен',
            'percent': 35,
            'summary': 'Басшылық лауазымда емес – бәріне белгілі және сол істе тәжірибесі бар жұмыс саласының істерін тапсыруға болады.'
        }
    }
    LOW_RESULT = {
        'ru': {
        ...
        'kz': {
            'classification': 'төмен',
            'percent': 10,
            'summary': 'Басшылық лауазымда емес – алдын ала дайындығы бар немесе біліктілігі дәлелденген аймаққа тағайындалу ұсынылады.'
        }
    }
    VERY_LOW_RESULT = {
        'ru': {
        ...
        'kz': {
            'classification': 'өте төмен',
            'percent': 5,
            'summary': 'Егер денсаулығында кінәрәт болмаса немесе қандай да бір жолмен жұмыс істей алмайтын болса, тек дәлелденген құзыреттілік пен біліктілікпен жұмыс тағайындалуы керек.'
        }
    }
