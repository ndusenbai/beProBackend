...
class TestThree:
    HIGH = {
        ...
        'result': {
            'ru': {
                'description': 'ВЫСОКИЙ УРОВЕНЬ. Очень хорошая способность к воспроизведению. Такой человек всё понимает и схватывает на лету, и его уровень воспроизведения достаточен для руководителя высшего звена.'
            },
            'kz': {
                'description': 'ЖОҒАРЫ ДЕҢГЕЙ. Өнімділікке деген қабілеттілігі өте жақсы деңгейде. Мұндай адам барлығын тез түсініп, ұғады. Оның басшы болуға жетерліктей қабілеті бар.'
            }
        }
    }
    ...
    GOOD = {
        ...
        'result': {
            'ru': {
                'description': 'ХОРОШИЙ УРОВЕНЬ. Человек с таким воспроизведением хорошо понимает и разбирается в том, что происходит в какой-то определенной области. Такой уровень воспроизведения является достаточным для руководителя высшего или среднего звена.'
            },
            'kz': {
                'description': 'ЖАҚСЫ ДЕҢГЕЙ. Мұндай қабілеті бар адам, нақты бір салада не боп жатқанының бәрінен хабардар және түсінігі жақсы дамыған. Мұндай адамның қабілеті жоғарғы немесе орта буынның жетекшісі болуға жетеді.'
            }
        }
    }
    ...
    ACCEPTABLE = {
        ...
        'result': {
            'ru': {
                'description': 'ПРИЕМЛЕМЫЙ УРОВЕНЬ. Человек воспроизводит посредственно, но отнюдь не всегда медленно. Такой уровень достаточен для руководителя низшего звена или для человека, не занимающего руководящую должность.'
            },
            'kz': {
                'description': 'ЖАРАМДЫ ДЕҢГЕЙ. Бұл адамның қабілеттілік деңгейі орташа, бірақ тым баяу емес. Мұндай деңгей, төменгі буынға басшылық жасауға жетеді немесе мүлде басшылық лауазымын атқара алмайтын адамға тиесілі болады.'
            }
        }
    }
    ...
    LOW = {
        ...
        'result': {
            'ru': {
                'description': 'НИЗКИЙ УРОВЕНЬ. Такой человек может быть подвержен несчастным случаям, и ему тяжело приспосабливаться к обстоятельствам. Он может выполнять простые приказы, если он понял, что от него требуется. Человека с таким уровнем воспроизведения не рекомендуется принимать на работу, связанную с управлением каким-либо оборудованием.'
            },
            'kz': {
                'description': 'ТӨМЕН ДЕҢГЕЙ. Мұндай адам жазатайым оқиғаларға бейім болуы мүмкін және оның жағдайға бейімделуі қиын. Ол өзінен не талап етілетінін түсіне білсе, өзіне берілген қарапайым бұйрықтарды орындай алады. Қабілеттіліктің мұндай деңгейіндегі адамды, белгілі бір құрал-жабдықты басқаратындай жұмысқа алудың қажеті жоқ.'
            }
        }
    }
