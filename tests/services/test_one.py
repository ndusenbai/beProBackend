...
def process_test_one(answers: list, is_man: bool):
    points, unstables = get_points_for_test_one(answers)
    percents = get_percent_for_test_one(points, is_man)
    return get_result_for_test_one(percents, unstables)
...
def get_result_for_test_one(percents, unstables):
