...
def generate_employees_timesheet_excel(company, departments):
    ...
    for employee in employees:
        ...
        timesheet_dict = {timesheet.day.date(): timesheet for timesheet in employee.timesheet_set.all()}
        schedule_dict = {schedule.week_day: schedule for schedule in employee.employeeschedule_set.all()}
