...
class CompanyAdmin(admin.ModelAdmin):
    list_display = ('id', 'name', 'legal_name', 'owner', 'is_deleted', 'max_employees_qty', 'is_active')
...
class RoleAdmin(admin.ModelAdmin):
    ...
    search_fields = ('company__name', 'company__legal_name', 'department__name', 'user__last_name', 'user__first_name', 'user__middle_name')
